...
describe('createVehicle()', () => {
  ...
  it("should calculate the vehicle's total travel time after multiple deliveries (Vehicle 1)", () => {
    ...
    expect(delivery1[0].totalDeliveryTime).toBe(1.78);
    expect(delivery1[1].totalDeliveryTime).toBe(0.85);
    expect(delivery2[0].totalDeliveryTime).toBe(3.98);
  });
  ...
  it("should calculate the vehicle's total travel time after multiple deliveries (Vehicle 2)", () => {
    ...
    expect(vehicle.packages[0].totalDeliveryTime).toBe(1.42);
    expect(vehicle.packages[1].totalDeliveryTime).toBe(4.19);
  });
});
